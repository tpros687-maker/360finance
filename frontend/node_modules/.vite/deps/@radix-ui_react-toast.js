...
function createSlot3(ownerName) {
  ...
  const Slot22 = React7.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime8.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React7.isValidElement(newElement) ? React7.cloneElement(newElement, void 0, newChildren) : null });
    }
    ...
    return (0, import_jsx_runtime11.jsxs)(
      Branch,
      {
        ...
        children: [
          ...
          (0, import_jsx_runtime11.jsx)(Collection.Slot, { scope: __scopeToast, children: (0, import_jsx_runtime11.jsx)(Primitive.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && (0, import_jsx_runtime11.jsx)(
            FocusProxy,
            {
...
var ToastImpl = React10.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
      ...
      (0, import_jsx_runtime11.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM3.createPortal(
...
var ToastTitle = React10.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime11.jsx)(Primitive.div, { ...titleProps, ref: forwardedRef });
  }
);
...
var ToastDescription = React10.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime11.jsx)(Primitive.div, { ...descriptionProps, ref: forwardedRef });
  }
);
