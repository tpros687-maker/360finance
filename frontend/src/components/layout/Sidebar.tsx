...
const BASE_NAV = [
  ...
  { to: "/cuaderno",        label: "Cuaderno",             icon: BookOpen,        negocioOnly: false, ssoHidden: false },
  { to: "/resumenes",       label: "Resúmenes mensuales",  icon: BarChart3,       negocioOnly: false, ssoHidden: false },
  { to: "/mercado",          label: "Mercado Ganadero",     icon: LineChart,       negocioOnly: false, ssoHidden: false },
